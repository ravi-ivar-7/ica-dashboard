...
import { AudioInputConfig } from './Types';
...
export default function AudioInputNode({ data }: AudioInputNodeProps) {
  const [isExpanded, setIsExpanded] = useState(!data.minimized);
  const [showConfig, setShowConfig] = useState(false);

  const config = data.config as AudioInputConfig;
            ...
            <div className="mt-6 pt-4 border-t">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={config.formats?.join(', ') || 'mp3, wav, aac'}
