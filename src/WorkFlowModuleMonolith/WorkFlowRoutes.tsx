...
import WorkflowHome from '@/WorkFlowModule/Dashboard/Pages/WorkFlowHome';
import WorkFlowEditor from '@/WorkFlowModule/Editor/Pages/WorkFlowEditor';
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-slate-900 flex items-center justify-center">
        <LoadingSpinner size="lg" text="Loading Workflow Module..." />
      </div>
    );
  }
