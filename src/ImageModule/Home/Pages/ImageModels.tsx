...
import { Image, Download, Play, Users, Clock, Star, ChevronRight, Filter, Search, Zap, Palette, Camera, Sparkles } from 'lucide-react';

const categories = [
  { id: 'all', name: 'All Models', icon: <Image className="w-4 h-4" />, count: 24 },
  { id: 'realistic', name: 'Realistic', icon: <Camera className="w-4 h-4" />, count: 8 },
  { id: 'artistic', name: 'Artistic', icon: <Palette className="w-4 h-4" />, count: 6 },
  { id: 'anime', name: 'Anime', icon: <Sparkles className="w-4 h-4" />, count: 5 },
  { id: 'portrait', name: 'Portrait', icon: <Users className="w-4 h-4" />, count: 3 },
  { id: 'landscape', name: 'Landscape', icon: <Image className="w-4 h-4" />, count: 2 }
];
...
const imageModels = [
  {
    id: 1,
    name: "SDXL",
    description: "High-quality image generation with exceptional detail and clarity",
    category: "realistic",
  ...
  },
  {
    id: 2,
    name: "DreamShaper",
    description: "Artistic style generation with creative flair and unique aesthetics",
    category: "artistic",
  ...
  },
  {
    ...
    description: "Photorealistic outputs with stunning detail and lifelike quality",
    category: "realistic",
  ...
  },
  {
    ...
    description: "Specialized for anime and manga style character generation",
    category: "anime",
  ...
  },
  {
    ...
    description: "Professional portrait generation with studio-quality lighting",
    category: "portrait",
    ...
    badges: ["Portrait", "Professional", "Lighting"],
    emoji: "👤"
  },
  {
    id: 6,
    name: "Landscape Pro",
    description: "Stunning landscape and nature scene generation",
    category: "landscape",
    ...
    badges: ["Landscape", "Nature", "Scenic"],
    emoji: "🏔️"
  }
];
...
export default function ImageModels() {
  ...
  const featuredModel = imageModels.find(model => model.featured);
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-6 py-12 sm:py-24">
        ...
        <div className="text-center mb-8 sm:mb-16">
          <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-purple-600/30 to-pink-600/30 backdrop-blur-xl border border-purple-500/40 rounded-full px-4 sm:px-6 py-2 sm:py-3 mb-6 sm:mb-8">
            <Image className="w-4 sm:w-5 h-4 sm:h-5 text-purple-400" />
            <span className="text-purple-300 font-bold text-sm sm:text-base">Image Generation Models</span>
          </div>
          ...
          <p className="text-lg sm:text-2xl text-white/80 max-w-4xl mx-auto">
            Create stunning images with our collection of specialized AI models
          </p>
        </div>
        ...
        <div className="mt-16 text-center bg-gradient-to-br from-gray-900/60 to-black/80 backdrop-blur-xl border border-white/20 rounded-3xl p-8 sm:p-12">
          ...
          <p className="text-lg sm:text-xl text-white/70 mb-8 max-w-2xl mx-auto">
            Start generating stunning images with our AI models
          </p>
