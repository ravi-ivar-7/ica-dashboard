...
import { Video, Upload, Search, Filter, Grid, List, Download, Trash2, Play, Plus, X, Check } from 'lucide-react';
import FileUploader from '@/CommonModule/Components/FileUploader';
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between bg-gradient-to-br from-gray-900/80 to-black/90 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-lg">
          <div>
            ...
            <p className="text-lg text-white/70">
              Organize and manage your video assets
            </p>
          </div>
          ...
          <div className="mt-4 lg:mt-0 flex flex-wrap gap-3">
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2.5 rounded-xl font-semibold transition-colors text-base ${isSelectionMode
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:items-center">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-xl bg-white/10 border-white/20 text-white placeholder-white/50 border focus:outline-none focus:border-red-400 focus:ring-2 focus:ring-red-400/20 transition-all"
              />
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/80 to-black/90 backdrop-blur-xl border border-white/20 rounded-3xl p-8 text-center">
              ...
              <p className="text-white/70 mb-6 text-base">
                {searchQuery || filterType !== 'all'
                  ...
                  : 'Get started by uploading videos'}
              </p>
              <button
                onClick={() => setShowUploader(true)}
                className="flex items-center space-x-2 px-4 py-2.5 rounded-xl font-semibold bg-white/10 hover:bg-white/20 text-white transition-colors text-base"
              ...
              {filteredAssets.map((asset) => (
                <div key={asset.id} className="relative">
                  {isSelectionMode && (
                    ...
                    >
                      <div className={`w-5 h-5 rounded-full border-2 ${selectedAssets.includes(asset.id)
                    ...
                    <div className="flex items-center bg-gradient-to-br from-gray-900/80 to-black/90 backdrop-blur-xl border border-white/20 rounded-xl p-4 hover:border-white/30 transition-all duration-300">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className={`ml-2 px-2 py-0.5 rounded-full text-xs font-bold ${asset.status === 'ready'
                        ...
                        <p className="text-white/60 text-xs mb-1">{asset.duration} • {asset.size} • {asset.createdAt}</p>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-2xl bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-2xl border border-white/20 rounded-3xl p-6 shadow-2xl">
            ...
            <FileUploader
              ...
              description="MP4, MOV, AVI (max 100MB each)"
            />
            ...
            <div className="flex justify-end mt-6 space-x-3">
              ...
              <button
                onClick={() => setShowUploader(false)}
                className="bg-gradient-to-r from-red-500 to-pink-500 text-white font-bold px-6 py-2.5 rounded-xl hover:scale-105 transition-all duration-300 shadow-lg flex items-center space-x-2 text-base"
              >
