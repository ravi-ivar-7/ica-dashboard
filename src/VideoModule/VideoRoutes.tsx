...
import VideoGenerator from '@/VideoModule/Dashboard/Pages/VideoGenerator';
import VideoEditor from '@/VideoModule/Dashboard/Pages/VideoEditor';
import VideoThumbnail from '@/VideoModule/Dashboard/Pages/VideoThumbnail';
import VideoManager from '@/VideoModule/Dashboard/Pages/VideoManager';
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-slate-900 flex items-center justify-center">
        <LoadingSpinner size="lg" text="Loading Video Module..." />
      </div>
    );
  }
