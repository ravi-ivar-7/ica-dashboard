...
import { Image, Upload, Filter, Search, Zap, Download, Trash2, Plus, X, Check, Settings, Info, Pencil } from 'lucide-react';
...
// Tabs for the image section
const tabs = [
  { id: 'generator', label: 'Generator', icon: <Zap className="w-4 h-4" /> },
  { id: 'canvas', label: 'Canvas', icon: <Pencil className="w-4 h-4" /> }
];
...
export default function DashboardImages() {
  ...
  // Render the Generator tab content
    ...
    <div className="bg-gradient-to-br from-gray-900/80 to-black/90 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-lg">
      <div className="flex items-center justify-center h-[400px]">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Image Canvas</h3>
          <p className="text-white/70 mb-4">Draw, edit, and enhance your images</p>
    ...
    <ErrorBoundary>
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-gray-900/80 to-black/90 backdrop-blur-xl border border-white/20 rounded-3xl p-4 shadow-lg">
          ...
          {/* Tab Content */}
          {activeTab === 'generator' ? renderGeneratorTab() : renderCanvasTab()}
        </div>
